...
def initialize_parameter():
    ...
    parser.add_argument('--true_file', type=str, required=False, default='./TrueValue/most_samll_test_1个变量真实值.xlsx', help='真实值数据的文件名')

    # parser.add_argument('--data_path', type=str, default='周粒度-多特征数据汇总.csv', help='data file')
    parser.add_argument('--data_path', type=str, default='most_samll_test_1个变量.csv', help='data file')

    # parser.add_argument('--columns', type=list, required=False, default=["date",'X1','X2','X3'], help='存储预测数据的时候的列名，多对多M')
    parser.add_argument('--columns', type=list, required=False, default=["date",'X4'], help='存储预测数据的时候的列名，多对多M')
